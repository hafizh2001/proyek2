...
<head>
    ...
    <title>CV SATRIA MADURA - Dashboard</title>
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="home">
    ...
    <div class="sidebar-brand-text mx-3">CV SATRIA MADURA <sup></sup></div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="KeluarMasukProduk" >Transaksi Produk</a>
            <a class="collapse-item" href="keluar" >Produk Keluar</a>
            <a class="collapse-item" href="masuk" >Produk Masuk</a> 
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="userr">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CV satria Madura 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
